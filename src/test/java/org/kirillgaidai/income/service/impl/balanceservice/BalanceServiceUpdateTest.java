...
public class BalanceServiceUpdateTest extends BalanceServiceBaseTest {
    ...
    /**
     * Test balance to manual
     *
     * @throws Exception exception
     */
    @Test
    public void testBalanceToManual() throws Exception {
        Integer accountId = 1;
        LocalDate day = LocalDate.of(2017, 11, 27);
    ...
    public void testBalanceToAutoThisDayOperationsFound() throws Exception {
        ...
        BalanceDto expected = new BalanceDto(accountId, "title", day, new BigDecimal("10"), false);
        BalanceDto actual = service.update(dto);
        assertEntityEquals(expected, actual);
        ...
        BalanceEntity expectedEntity = new BalanceEntity(accountId, day, new BigDecimal("10"), false);
        BalanceEntity actualEntity = argumentCaptor.getValue();
        assertEntityEquals(expectedEntity, actualEntity);
    }

    /**
     * Test balance to auto previous balance found
     *
     * @throws Exception exception
     */
    @Test
    public void testBalanceToAutoPreviousBalanceFound() throws Exception {
        Integer accountId = 1;
        ...
        BalanceDto expected = new BalanceDto(accountId, "title", thisDay, new BigDecimal("5"), false);
        BalanceDto actual = service.update(dto);
        assertEntityEquals(expected, actual);
    ...
    /**
     * Test balance to auto next balance not found
     *
     * @throws Exception exception
     */
    @Test
    public void testBalanceToAutoNextBalanceNotFound() throws Exception {
        Integer accountId = 1;
        LocalDate thisDay = LocalDate.of(2017, 11, 27);
        ...
        BalanceDto expected = new BalanceDto(accountId, "title", thisDay, BigDecimal.ZERO, false);
        BalanceDto actual = service.update(dto);
        assertEntityEquals(expected, actual);
    ...
    /**
     * Test balance to auto next balance found
     *
     * @throws Exception exception
     */
    @Test
    public void testBalanceToAutoNextBalanceFound() throws Exception {
        Integer accountId = 1;
        LocalDate thisDay = LocalDate.of(2017, 11, 27);
    ...
    public void testBalanceToAutoNextBalanceAndOperationsFound() throws Exception {
        ...
        doReturn(1).when(balanceDao).update(any(BalanceEntity.class), eq(thisEntity));
        ...
        verify(operationDao).getCountByAccountIdAndDay(accountId, thisDay);
        verify(operationDao).getCountByAccountIdAndDay(accountId, afterDay);
        verify(balanceDao).update(argumentCaptor.capture(), eq(thisEntity));

        verifyNoMoreDaoInteractions();

        BalanceEntity expectedEntity = new BalanceEntity(accountId, thisDay, new BigDecimal("10"), true);
        BalanceEntity actualEntity = argumentCaptor.getValue();
        assertEntityEquals(expectedEntity, actualEntity);
    }
